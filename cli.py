...
from fixtures.make_fixtures import make, make_vlm_fixtures
...
def main(argv=None):
    ...
    a.add_argument("out"); a.add_argument("--kind", choices=["rules", "vlm"], default="rules")
    ...
    if args.cmd == "fixtures":
        fn = make if args.kind == "rules" else make_vlm_fixtures
        ...
        s = run_qc(args.folder, out_dir=args.out, expected_dpi=args.dpi,
